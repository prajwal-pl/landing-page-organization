...
export const SectionReorderingPanel: React.FC = () => {
  ...
  const handleSave = async () => {
    try {
      ...
      setSaveMessage({
        text: "Section order saved successfully! Opening homepage to preview changes.",
        type: "success",
      });
      ...
      setSaveMessage({
        text: "Failed to save section order. Please try again.",
        type: "error",
      });
    ...
    <Card className="w-full">
      <CardHeader>
        ...
        <p className="text-sm text-gray-500">
          Drag and drop sections to change their order on the landing page.
        </p>
      </CardHeader>
      <CardContent>
        <div className="mb-4">
