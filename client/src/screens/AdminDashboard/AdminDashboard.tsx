      ...
      <main className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        <div className="bg-white shadow rounded-lg p-6 mb-6">
          ...
          <p className="text-gray-600">
            Here you can manage the organization of landing page sections.
            Use the drag-and-drop interface below to reorder sections as needed.
          </p>
        </div>
        ...
        <div className="mt-6 bg-blue-50 p-4 rounded-md border border-blue-100">
          ...
          <ul className="list-disc pl-5 text-blue-700 text-sm space-y-1">
            ...
            <li>The default admin credentials are username: <strong>admin</strong> and password: <strong>admin123</strong></li>
          </ul>
        </div>
      </main>
    </div>
